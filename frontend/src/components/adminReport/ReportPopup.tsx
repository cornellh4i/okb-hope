  ...
  return (
    <div style={cardStyle} className="card bg-base-100  mb-4">
      <div>
        ...
        <h2 style={{ marginBottom: '10px' }} className="font-bold font-montserrat">Person Reported: <span className="font-normal">{showPatientsReports ? report.patient_name : `Dr. ${report.psych_name}`}</span> </h2>
