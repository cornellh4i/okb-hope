...
const SearchBar = ({ onSearch }: SearchBarProps) => {
  ...
  return (
    <div className={`search-bar`}>
      <div className={`flex py-2 md:px-4 px-4 items-center md:gap-4 gap-2 shrink-0 rounded-lg justify-between search-form border-solid border-[1px] border-[${okb_colors.dark_gray}] md:mx-4 my-5 text-lg font-semibold`}>
