...
import DummyPsychiatristPic from '../assets/dummy_psychiatrist.svg'
    ...
    <div className="psychiatrist-list space-y-16">
      {results.map((psychiatrist) => (
        <div key={psychiatrist.id} className="psychiatrist">
          ...
          <div className="card card-side bg-base-100 shadow-xl grid-cols-5 px-3 place-items-center">
            {/* <div className="col-span-1"><figure><img src="/" alt="Profile Pic" /></figure></div> */}
            <div className="col-span-1 "><figure><DummyPsychiatristPic /></figure></div>
            <div className="card-body col-span-3">
              ...
              <p className="text-[#000000] text-[12px]">{psychiatrist.description}</p>
            </div>
          </div>
        </div >
      ))
