// // Brianna's edits: delete this later
...
// // export const BookingPopupWindow: React.FC<{ onClose: () => void, url: string }> = ({ onClose, url }) => {
// //   return (
// //     <div className="popup-container">
// //       <div className="popup-content">
...
// export const BookingPopupWindow: React.FC<{ url: string, onClose: () => void }> = ({ url, onClose }) => {
//   return (
//     <div className="popup-container">
//       <div className="popup-content">
//         <InlineWidget url={url} />
